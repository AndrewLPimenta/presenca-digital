...
function Registration() {
    ...
    const loadAlunos = async () => {
        try {
            const response = await fetch('https://precenca-digital-back-end-2998.vercel.app/api/alunos');
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://precenca-digital-back-end-2998.vercel.app/api/register', {
                method: 'POST',
                headers: {
