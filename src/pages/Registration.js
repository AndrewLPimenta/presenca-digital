...
function Registration() {
    ...
    const loadAlunos = async () => {
        try {
            const response = await fetch('https://precenca-digital-back-end.onrender.com/api/alunos');
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await fetch('https://precenca-digital-back-end.onrender.com/api/register', {
                method: 'POST',
                headers: {
